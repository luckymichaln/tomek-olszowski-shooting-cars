<template>
  <div class="to-gallery">
    <div class="to-gallery-block" v-for="(item, index) of content" :key="index">
      <div
        ...
        >
          ...
          >
            ...
            <div class="brick-info">
              ...
              <div class="info-block" v-for="(aboutBlock, index) in item.about" :key="index">
                <span>{{ aboutBlock.label }}:</span>
                <span>{{ aboutBlock.info }}</span>
              </div>
            </div>
          </router-link>
          <span v-else class="brick-nolink" v-lazy="img.src.url">
            <img
              v-if="!img.isEmpty"
              :key="index"
              :srcset="srcSet(img)"
      ...
      <div class="to-gallery-block__row--mobile-wrapper">
        ...
        <div class="to-gallery-block__row--mobile row-vimeo" v-if="item.vimeoid">
